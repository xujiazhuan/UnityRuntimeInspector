...
#pragma warning disable 0649
        [SerializeField] private RectTransform colorPickerArea;

        [SerializeField] private PointerEventListener inputColor;
...
#pragma warning restore 0649
        ...
        private void ShowColorPicker(PointerEventData eventData)
        {
            ...
            ColorPicker.Instance.Show(OnColorChanged, null, value, rectTransform.position,
                new Vector2(rectTransform.rect.width * rectTransform.pivot.x,
